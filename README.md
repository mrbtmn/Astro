...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/mrbtmn/Astro/main/Astro.sh)
```
Or :
...
a.
```bash
wget https://raw.githubusercontent.com/mrbtmn/Astro/main/Astro.sh
...
```bash
git clone https://github.com/mrbtmn/Astro.git
cd Astro
```
